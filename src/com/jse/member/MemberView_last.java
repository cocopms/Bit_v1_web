...
public class MemberView_last extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == saveButton) {
			...
			String data = String.format("%s / %s / %s / %s / %s", textFields[0].getText(), textFields[1].getText(),
